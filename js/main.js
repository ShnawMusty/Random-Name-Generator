...
const clearSuggestions = () => {
    ...
    const list = document.querySelector(".suggestion ol");
    list.innerHTML = "";
};
...
const displayNames = (namesArray) => {
    const list = document.querySelector(".suggestion ol")
    const rawFirstName = document.getElementById("submit__textInput").value;
    const firstName = sanitize(rawFirstName);
